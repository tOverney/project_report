...
\chapter{Introduction}
    ...
    Due to their SIMD nature, GPU have been used in different scientific field to perform
    non-graphical computations for a while. They're used for particle and molecular dynamic 
    modelisation, astrophysic and fluid mechanic modeling.
    ...
    Cryptography related applications make heavy use of very large integers operations.
...
% Change name and create chapter for microbenchmarking
\section{Methods}
...
\chapter{Beyond the current architecture}
   ...
   \subsection{Plan A}
    Add a 32-bit multiplier to each cores who doesn't have one yet. So all 32 cores would have a full float unit and a 32-bit multiplier.
