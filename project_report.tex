...
\chapter{First approach}
    ...
    explored:
    % INSERT MONTOMERY SHIT HERE

    And the impact of the new opcodes were to be measured with the assistance of
    GPGPU-SIM\cite{gpgpusim09} a Fermi architecture simulator.
