...
\section{Understanding pipeline length and performance deterioration}
    ...
    is suspected to be $\cfrac{1}{9}$ of the base cost as the scheduling is expected to be
...
\section{Results}
    ...
    From the previous observation the following ideas are expected to drastically
...
\section{Instruction level parallelism}
    ...
    scheme as described by \ref{fig:fp_prediction_64_halfdep}.
...
\begin{figure}[H]
   ...
   \end{figure}
    ...
    \subsection{Results}
    \begin{figure}[H]\label{fig:ilp_results}
		\centering
		\vspace{-20pt}
    ...
    The running time for a million operations goes down to 9 million cycles in \ref{fig:ilp_results}
...
\chapter{Beyond the current architecture}
   ...
   \begin{figure}[H]
    ...
    Which represent an increase of $1.5\%$ on the full chip size.
